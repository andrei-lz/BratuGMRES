...
for p in 4 2 1; do
  mpirun -np $p ./build/bratu2d --N 1024 --lambda 3.0 --rtol 1e-8 --gmres_restart 50 --max_newton 30 --output_prefix data/strong_N1024_P${p}
done
...
$p)
  ...
  N=$((256 * root))
  mpirun -np $p ./build/bratu2d --N ${N} --lambda 3.0 --rtol 1e-8 --gmres_restart 50 --max_newton 30 --output_prefix data/weak_loc256_P${p}
done
